...
with utils_impl.record_hparam_flags() as optimizer_flags:
  ...
  optimizer_utils.define_lr_schedule_flags('finetune')
...
with utils_impl.record_hparam_flags() as shared_flags:
  ...
  flags.DEFINE_string('root_output_dir', '/tmp/fed_p13n/',
...
def main(argv):
  ...
  finetune_optimizer_fn = optimizer_utils.create_optimizer_fn_from_flags('finetune')
  ...
  if FLAGS.task == 'cifar100':
    raise NotImplementedError(
        "Personalized CIFAR100 task is not available yet.")
    ...
    raise NotImplementedError(
      "Personalized StackOverflow NWP task is not available yet.")
    ...
    raise NotImplementedError(
        "Personalized StackOverflow LR task is not available yet.")
